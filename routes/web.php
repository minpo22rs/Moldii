...
use App\Http\Controllers\mobile\common\ChatController;
...
Route::get('sharePost', [ContentController::class, 'sharePost']);//share
...
//Chat
Route::get('/chatMsg/index/{id}', [ChatController::class, 'index']);
Route::post('/chatMsg/send_message', [ChatController::class, 'sendMessage']);
Route::get('/chatMsg/fetch_message', [ChatController::class, 'fetchMessage']);
...
// Route::get('/testchat/send_message', [TestUiController::class, 'sendMessage']);
// Route::get('/testchat/fetch_message', [TestUiController::class, 'fetchMessage']);

// Route::get('/testchat/to_chat/{id}', [TestUiController::class, 'to_chat']);
