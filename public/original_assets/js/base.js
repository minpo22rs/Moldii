...
///////////////////////////////////////////////////////////////////////////
// Toast
// toast box extra without bottom bar
function toastboxextra_without_bottom_bar(target, time) {
    var a = "#" + target;
    $(".toast-box-extra").removeClass("show_without_bottom_bar");
    setTimeout(() => {
        $(a).addClass("show_without_bottom_bar");
    }, 100);
    if (time) {
        time = time + 100;
        setTimeout(() => {
...
function toastbox(target, time) {
    var a = "#" + target;
    $(".toast-box-white").removeClass("show");
    setTimeout(() => {
        $(a).addClass("show");
    }, 100);
    if (time) {
