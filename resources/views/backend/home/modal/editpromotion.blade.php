    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">แก้ไขโปรโมชั่น</h4>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">
                            <span class="mytooltip tooltip-effect-1">
                                <span class="tooltip-item2">โปรโมชั่น <span class="text-danger">*</span></span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <button type="button" class="btn btn-success btn-outline-success btn-round" onclick="document.getElementById('editdocument').click();">
                                        <i class="icofont icofont-image"></i> เปลี่ยนโปรโมชั่น</button> 
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary waves-effect waves-light" form="edit_promotion">ยืนยัน</button>
            </div>
        </div>
    </div>
</div>