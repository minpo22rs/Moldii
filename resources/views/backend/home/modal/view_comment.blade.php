            ...
            <div class="modal-body">
                <ul class="feed-blog">
                    ...
                    <li>
                        ...
                        {{-- <div class="row">
                            <div class="col-sm-2"><i class="icofont icofont-thumbs-up" style="font-size: 22px; color: #4099ff;"></i> 0</div>
                            <div class="col-sm-2"><i class="icofont icofont-thumbs-down" style="font-size: 22px; color: #FF5370;"></i> 0</div>
                            <div class="col-sm-4">
                                @for ($i = 0; $i < 5; $i++)
