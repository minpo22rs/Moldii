...
<form action="">
    ...
    <div class="row p-2 col-12 m-0    " style="color:black; font-size:18px">
        ...
        <input style="border-radius: 10px; height:2.8125rem;" type="text" name="phone" class="form-control mt-1 input_3  " placeholder="•••• •••• •••• ••••">
        ...
        <input style="border-radius: 10px; height:2.8125rem;" type="text" name="phone" class="form-control mt-1 input_3  " placeholder="Cardholder name">
    </div>
    ...
    <div class="row  col-12 m-0  mt-1  " style="color:black; font-size:18px">
        <div class="col-6">
            ...
            <input style="border-radius: 10px; height:2.8125rem;" type="text" name="phone" class="form-control mt-1 input_3  " placeholder="MM/YY">
        </div>
