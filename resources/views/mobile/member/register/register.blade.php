...
<div class="m-1">
    <div class="m-1">
        <div class="row align-items-center">
            ...
            <div class="col-6 text-right" style="margin-top: 50%;">
                <h1 class="">
                    Register
                </h1>
            </div>
            ...
            <div class="col-6 text-center" style="margin-top: 50%;">
                <div class="m-1">
            ...
            <form action="{{route('Register')}}" method="POST" class="form-group row">
            @csrf
                ...
                <div class="col-10 offset-1 text-center">
                    <input type="password" class="form-control form-control-lg my-1" style="border-radius: 10px;" name="password" id="password" value="" placeholder="Password">
                </div>
