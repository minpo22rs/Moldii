            ...
            <div class="carousel-multiple owl-carousel owl-theme">
                {{-- @if($group->count() <2 )
                    <div class="item test-1057 ">
                        <div class = "card">
                            <img src="{{('https://testgit.sapapps.work/moldii/storage/app/group_cover/'.$group[0]->group_img.'')}}" alt="alt" class="imaged w-100" style=" height:180px;">
                            <div class="row col-12 item-1057">
                                <div class="name row align-self-end mb-1">
                                    
                                    <h5 class="ml-1 align-self-center m-0">{{$group[0]->name}}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
