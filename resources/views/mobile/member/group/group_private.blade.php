...
<div class="col-md-12">
    ...
    <div class="col-md-12">
        ...
        <div class="pt-2" style="font-weight: 500; font-size: 110% ;">[icon] Private </div> 
        <div> Only members can see who's in the group and what they post. </div>
        <div class="pt-2" style="font-weight: 500; font-size: 110% ;">[icon] Visible</div>
        <div> Anyone can fine this group.</div>
        <div class="pt-2" style="font-weight: 500; font-size: 110% ;">[icon] History</div>
        ...
        <hr> <!-- ------------------ -->
        <div class="pt-2" style="font-weight: bold; color: #1C2833 ; font-size: 130% ; " > Group activity  </div> 
        <div class="pt-2" style="font-weight: 500; font-size: 110% ;">[icon] 1,150 new post today </div> 
        <div> 23,000 in the last month. </div>
        <div class="pt-2" style="font-weight: 500; font-size: 110% ;">[icon] 153.8K members </div> 
        <div> +1,850 in the last week. </div>
        <div class="pt-2 pb-2" style="font-weight: 500; font-size: 110% ;">[icon] Created 4 years ago </div> 
        <hr> <!-- ------------------ -->
        <div style="text-align: center; padding : 0 20 0 20 ; ">
        <div class="pt-5">[ Image ]</div>
