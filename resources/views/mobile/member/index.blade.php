...
@section('content')
    ...
    <form id="widget-form" class="widget-post__form" name="form" action="{{url('userpostcontent')}}" method="POST" aria-label="post widget" enctype="multipart/form-data">
                ...
                <div class="widget-post" aria-labelledby="post-header-title">
                    ...
                    <h2 class="widget-post__title" id="post-header-title">
                        ...
                        <div class="widget-post__content">
                            ...
                            <div class="row" id="rowsocial" style="display: none"> </div>
                        ...
                        <div class="widget-post__actions post--actions">
                            <div class="post-actions__attachments">
                                ...
                                <button type="button" class="btn post-actions__upload attachments--btn" data-toggle="modal" data-target="#upload">
                                    <label for="upload-video" class="post-actions__label">
                                        <i class="fa fa-video " aria-hidden="true"></i> 
                                    </label>
                                </button>
                            
                                <button type="button" class="btn post-actions__upload attachments--btn" data-toggle="modal" data-target="#Layout">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="files">เลือกรูปภาพของคุณ</label>
                                <input id="files" type="file" multiple="multiple" name="imagefile[]" accept="image/*;capture=camera">
                                <output class="col-md-6" id="result">
                            </div>
                            ...
                            <script>
                                document.querySelector("#files").addEventListener("change", (e) => { //เปลี่ยนกิจกรรมสำหรับการอัพโหลดภาพถ่าย
                                    if (window.File && window.FileReader && window.FileList && window.Blob) { //ตรวจสอบว่า File API รองรับหรือไม่
                                        const files = e.target.files; //รายการไฟล์วัตถุที่มีไฟล์ที่อัปโหลด
                                        const output = document.querySelector("#result");
                                        const x = document.querySelector("#rowsocial");
                                        output.innerHTML = "";
                                        // var vi =0;
                                        for (let i = 0; i < files.length; i++) { //วนซ้ำผ่านออบเจ็กต์รายการไฟล์
                                            // รูปถ่ายเท่านั้น (ข้ามการวนซ้ำหากไม่ใช่ภาพถ่าย)
                                            const picReader = new FileReader(); // ดึงข้อมูล URI
                                            picReader.addEventListener("load", function (event) { //โหลดกิจกรรมเพื่อแสดงภาพถ่าย
                                                ...
                                                // if (!files[i].type.match("image")) {
                                                    ...
                                                    div.innerHTML = `<video id="video" width="100%" height="150" controls ><source src="${picFile.result}" type=video/ogg><source src="${picFile.result}" type=video/mp4></video>`+
                                                                    `<a href="#" class="badge badge-danger" onclick="del_img(${i})"> ลบ </a>`;


                                                    
                                                    divs.setAttribute("class", "div"+i);
                                                    
                                                    divs.innerHTML = `<video id="video" width="100%" height="150" controls ><source src="${picFile.result}" type=video/ogg><source src="${picFile.result}" type=video/mp4></video>`+
                                                                    `<a href="#" class="badge badge-danger" onclick="del_img(${i})"> ลบ </a>`;
                                                    ...
                                                    div.setAttribute("class", "div"+i);
                                                    div.innerHTML = `<img id="img_show${i}" class="thumbnail" src="${picFile.result}" title="${picFile.name}"/>`+
                                                                    `<a href="#" class="badge badge-danger" onclick="del_img(${i})"> ลบ </a>`;


                                                    
                                                    divs.setAttribute("class", "div"+i);
                                                    divs.innerHTML = `<img id="img_show${i}" class="thumbnail" src="${picFile.result}" title="${picFile.name}"/>`+
                                                                    `<a href="#" class="badge badge-danger" onclick="del_img(${i})"> ลบ </a>`;
                                            ...
                                            picReader.readAsDataURL(files[i]); //อ่านภาพ
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary btn-block" onclick="showimage();">ยืนยัน</button>
                        <button type="button" class="btn btn-danger btn-block" data-dismiss="modal" data-toggle="modal" data-target="#Layout">ยกเลิก</button> <!-- reset หน้าเพจ -->
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- upload no layout1 -->
        <div class="modal fade" id="uploadlayout1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">เพิ่มรูปภาพ</h5>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="files">เลือกรูปภาพของคุณ</label>
                                <input id="files" type="file" multiple="multiple" name="imagefile[]" minlength="3" maxlength="3" accept="image/*;capture=camera">
                                <output class="col-md-6" id="resultlayout1">
                            </div>
                           <div  id="layout-1" class="col-md-12 pb-2 container-box-layout-1">
                                <div class="box-layout-1 a-layout-1 "><img src="{{asset('new_assets/img/Moldii.png')}}" style="width: 100%;height:100%"></div>
                                <div class="box-layout-1 b-layout-1 "><img src="{{asset('new_assets/img/Moldii.png')}}" style="width: 100%;height:100%"></div>
                                <div class="box-layout-1 c-layout-1 "><img src="{{asset('new_assets/img/Moldii.png')}}" style="width: 100%;height:100%"></div>   
                           </div>
        ...
        <!-- Modal choose Layout -->
        <div class="modal fade" id="Layout" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">เลือกรูปแบบ Layout</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="row">
                    ...
                    <button type="button" class="btn btn-info btn-block" data-dismiss="modal" data-toggle="modal" data-target="#layout1" >รูป layout แบบที่ 1 </button>
                    </div>
                    <div class="container col-md-6"><br>
                    <button type="button" class="btn btn-info btn-block" data-dismiss="modal" data-toggle="modal" data-target="#layout2" >รูป layout แบบที่ 2 </button>
                    </div>
                    <div class="container col-md-6"><br>
                    <button type="button" class="btn btn-info btn-block" data-dismiss="modal" data-toggle="modal" data-target="#upload" >ไม่มี layout</button>
                    </div>
                </div>
        ...
        <!-- Modal Layout 1 -->
        <div class="modal fade" id="layout1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary btn-block" data-dismiss="modal" data-toggle="modal" data-target="#uploadlayout1">เลือกรูปภาพ</button>
                        <button type="button" class="btn btn-danger btn-block" data-dismiss="modal" data-toggle="modal" data-target="#Layout">ยกเลิก</button>
                    </div>
                </div>
            </div>
        </div> <!-- end modal Layout 1  -->

        <!-- Modal Layout 2 -->
        <div class="modal fade" id="layout2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                <div class="modal-header">
                ...
                <div id="layout-2" class="col-md-12 pb-2 container-box-layout-2">
                    <div class="box-layout-2 a-layout-2 "><img src="{{asset('new_assets/img/Moldii.png')}}" style="width: 100%;height:100%"></div>
                    <div class="box-layout-2 b-layout-2 "><img src="{{asset('new_assets/img/Moldii.png')}}" style="width: 100%;height:100%"></div>
                    <div class="box-layout-2 c-layout-2 "><img src="{{asset('new_assets/img/Moldii.png')}}" style="width: 100%;height:100%"></div>   
                    <div class="box-layout-2 d-layout-2 "><img src="{{asset('new_assets/img/Moldii.png')}}" style="width: 100%;height:100%"></div>   
                </div>
                ...
                @foreach ($c as $sqls)
                    ...
                    <div class="card my-3">
                        ...
                        <div class="card-footer row justify-content-center align-items-center" style="padding-left: 3px; padding-right: 3px;">
                            ...
                            <a href="#" data-toggle="modal" data-target="#share" >  <!--  #share ใส่ค่าตัวเลขที่ไม่ซ้ำกันหลัง #share เป็นไอดีหรืออะไรก็ได้-->
    ...
    {{-- searchBox --}}
        <script>
            ...
            function del_img(x){ //ลบภาพ
                // const element = document.getElementById("img_show"+x);
                // const element1 = document.getElementById("btnshow"+x);
                // element.remove();
                // element1.remove();
            ...
            function showimage(){
                $('#upload').modal('hide');
                document.getElementById('rowsocial').style.display = '';
