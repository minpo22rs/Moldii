...
<div class="container p-0">
    ...
    <div class="card-title row col-12 mb-0 p-1 pr-0 mt-1 justify-content-end">
        <h6 class="mb-0 ml-1 card-subtitle text-muted" id="countlike{{$c->new_id}}">{{$c->like?$c->like:'0'}} ชื่นชอบ</h6>
    ...
    <div class="card-footer row justify-content-center ">
        ...
        <div class="col-3 row p-0  justify-content-center" id="likebutton{{$c->new_id}}" style="display: ">
            <img src="{{ asset('new_assets/img/icon/heart 1.png')}}" alt="alt" style="width:17px; height:17px;">
            @if($la == null)
                <h5 class="mb-0 ml-1 " id="myLike{{$c->new_id}}" style="color: black" onclick="myLike({{$c->new_id}})">ถูกใจ</h5>
            @else
        ...
        <div style="display: none" class="col-3 row p-0  justify-content-center" id="myLike2{{$c->new_id}}" >
            <img src="{{ asset('new_assets/img/icon/heart 1.png')}}" alt="alt" style="width:17px; height:17px;">
            <h5 class="mb-0 ml-1 " style="color: black" onclick="myLike2({{$c->new_id}})">ถูกใจ</h5>
        </div>

        <div style="display: none" class="col-3 row p-0  justify-content-center" id="unmyLike2{{$c->new_id}}">
            <img src="{{ asset('new_assets/img/icon/heart 1.png')}}" alt="alt" style="width:17px; height:17px;">
