...
<div class="col-md-12  mt-3 ">
  ...
  <div class="mt-2 " align="center" >
        ...
        <a href="{{url('shopping/store_8/')}}">  <button type="button" class="btn  btn-sm  mr-1 p-1 align-self-center " style="width: 93px; height: 38px; background: #FBFCF9; color: #132D2F; font-size:13px; border-radius: 15px;">รายการสินค้า</button> </a>             
        ...
        <a href="{{url('shopping/store_10/')}}">  <button type="button" class="btn  btn-sm  mr-1 p-1 align-self-center " style="width: 69px; height: 38px; background: #FF5C63; color: white; font-size:13px; border-radius: 15px;">หมวดหมู่</button> </a>             
</div>    
        ...
        <div class="mt-3">
            <button class="accordion" style="font-weight: 500;">หมวดที่ 1</button>
            ...
            <button class="accordion">หมวดที่ 2</button>
            <div class="panel">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>

            <button class="accordion">หมวดที่ 3</button>
            <div class="panel">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>

            <button class="accordion">หมวดที่ 4</button>
            <div class="panel">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>

            <button class="accordion">สินค้าทั้งหมด</button>
            <div class="panel">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>
        </div>
