...
<div class="col-md-12  mt-3 ">
  ...
  <div class="mt-2 " align="center" >
        ...
        <a href="{{url('shopping/store_9/')}}">  <button type="button" class="btn  btn-sm  mr-1 p-1 align-self-center " style="width: 54px; height: 38px; background: #FF5C63; color: white; font-size:13px; border-radius: 15px;">มาใหม่</button> </a>             
