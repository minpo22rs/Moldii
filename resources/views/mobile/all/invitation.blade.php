...
<body class="bg-white">
    ...
    <!-- * loader -->
     ...
     <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">การแนะนำ</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
                        ...
                        <div class = "col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class = "row m-1 align-items-center">
                                <div class = "col text-center">
                                    <span class = "font-weight-bold">QR Code</span><br>
                                    <img src = "assets/custom_assets/qr_code/test_qrcode.png" ><br>
                                    
                                </div>
                            </div>
                        </div>
                        <div class = "col-sm-12 col-md-6 col-lg-6 col-xl-6 border-left">
                            <div class = "row m-1">
                                <div class = "col text-center">
                                    <span class = "font-weight-bold">ลิงก์</span><br>
                                    <input type = "text" class = "form-control my-1" value = "www.mangkorn.com/register.php?invite_code=1234">
                                    <input type = "button" class = "btn btn-primary" value = "คัดลอก">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class = "card-body">
                    <div class = "row align-items-center">
                        <div class = "col-12">
                            <div class = "row align-items-center">
                                <div class = "col text-left">
                                   <span class = "font-weight-bold">สมาชิกที่แนะนำ</span>
                                </div>
                ...
                <div class = "card-body">
                    <div class = "row align-items-center">
                        <div class = "col-12">
                            <div class = "row align-items-center">
                                <div class = "col text-left">
                                   <span class = "font-weight-bold">รายได้จากการแนะนำ</span>
                                </div>
                                <div class = "col text-right">
                                    <ion-icon name="chevron-forward-outline"></ion-icon>
                                </div>
                ...
                <div class = "card-body">
                    <div class = "row align-items-center">
                        <div class = "col-12">
                            <div class = "row align-items-center">
                                <div class = "col text-left">
                                   <span class = "font-weight-bold">การถอนรายได้</span>
                                </div>
                                <div class = "col text-right">
                                    <ion-icon name="chevron-forward-outline"></ion-icon>
                                </div>
