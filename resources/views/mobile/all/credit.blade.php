...
<body class="bg-white">
    ...
    <!-- * loader -->
     ...
     <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">เครดิต</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
                        ...
                        <div class = "col-12">
                            <div class = "row m-1">
                                <div class = "col-6 text-left">
                                    <span class = "font-weight-bold">ยอดเงินที่ใช้ได้</span>
                                </div>
                                <div class = "col-6 ml-auto text-right">
                                    <span class = "font-weight-bold">0 บาท</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class = "card-body text-danger">
                    <div class = "row align-items-center">
                        <div class = "col-12">
                            <div class = "row m-1">
                                <div class = "col-6 text-left">
                                    <span class = "font-weight-bold">ถอนเงิน</span>
                                </div>
                                <div class = "col-6 ml-auto text-right">
                                    <span class = "font-weight-bold">1,800 บาท</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class = "card-body text-success">
                    <div class = "row align-items-center">
                        <div class = "col-12">
                            <div class = "row m-1">
                                <div class = "col-6 text-left">
                                    <span class = "font-weight-bold">ฝากเงิน</span>
                                </div>
                                <div class = "col-6 ml-auto text-right">
                                    <span class = "font-weight-bold">1,800 บาท</span>
                                </div>
