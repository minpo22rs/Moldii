...
<body class="bg-white">
    ...
    <!-- * loader -->
     ...
     <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">สมาชิกที่แนะนำ</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
            ...
            <div class = "card shadow">
                <div class = "card-body">
                    <div class = "row align-items-center">
                        <div class = "col-sm-12 col-md-6 col-lg-6 col-xl-6 text-center my-1">
                            <span class = "font-weight-bold text-primary">หมายเลขโทรศัพท์</span><br>
                            <span class = "">0900000001</span>
                        </div>
                        <div class = "col-sm-12 col-md-6 col-lg-6 col-xl-6 text-center border-left my-1">
                            <span class = "font-weight-bold text-primary">วันเวลาที่สมัคร</span><br>
                            <span class = "">วันที่ 1 มกราคม 2564 เวลา 09:00:00</span>
                        </div>
                    </div>
                </div>
            </div>
