                            ...
                            <div class = "col text-left">
                                <div class = "row align-items-center">
                                    ...
                                    <h3 class = "text-primary mt-1 ml-1 mr-auto">
                                        กรุณาใส่เลขที่ต้องการและรายละเอียดรูปแบบตัวเลข
                                    </h3>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class = "col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class = "row m-1 align-items-center">
                                    <div class = "col-12 text-center">
                                        <input type = "text" class = "form-control" maxlength = "2" minlength = "2" placeholder = "ใส่เลข 2 หลัก" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class = "col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class = "row m-1 align-items-center">
                                    <div class = "col-8 offset-2 text-center">
                                        <input type = "button" class = "btn btn-primary btn-block" value = "แทง">
                                    </div>
                                </div>
                            </div>
