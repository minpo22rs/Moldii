...
<body class="bg-white">
    ...
    <!-- * loader -->
     ...
     <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">ข้อมูลบัญชีธนาคาร</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
                    ...
                    <div class = "card-body">
                        <div class = "row align-items-center">
                            <div class = "col-sm-12 col-md-1 col-lg-1 text-center">
                                <div class = "m-1"><img src = "assets/custom_assets/bank_icons/scb.png" style = "width: 100%;"></div>
                            </div>
                            <div class = "col-sm-12 col-md-11 col-lg-11">
                                <div class = "row m-1">
                                    <div class = "col text-left"><span class = "font-weight-bold">ธนาคารไทยพาณิชย์</span></div>
                                </div>
                                <div class = "row m-1">
                                    <div class = "col text-left">ชื่อเจ้าของบัญชี</div>
                                </div>
                                <div class = "row m-1">
                                    <div class = "col text-left">หมายเลขบัญชี</div>
                                </div>
                            </div>
                        </div>
                    </div>
