...
<body class="bg-white">
    ...
    <!-- * loader -->
     ...
     <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">เปลี่ยนรหัสผ่านใหม่</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
                ...
                <form action="#">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper text-left">
                            <label class = "font-weight-bold">รหัสผ่านเดิม</label>
                        </div>
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper text-left">
                            <label class = "font-weight-bold">รหัสผ่านใหม่</label>
                        </div>
                        <div class="input-wrapper">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper text-left">
                            <label class = "font-weight-bold">ยืนยันรหัสผ่านใหม่</label>
                        </div>
                        <div class="input-wrapper">
                            <input type="password" class="form-control" name = "confirm_new_password" id="confirm_new_password" placeholder="ยืนยันรหัสผ่านใหม่">
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                        </div>
