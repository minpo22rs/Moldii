...
<body class="bg-white">
    ...
    <!-- * loader -->
     ...
     <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">รายได้จากการแนะนำ</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
                        ...
                        <div class = "col-12">
                            <div class = "row m-1">
                                <div class = "col-6 text-left">
                                    <span class = "font-weight-bold">รายได้ทั้งหมด</span>
                                </div>
                ...
                <div class = "card-body text-success">
                    <div class = "row align-items-center">
                        <div class = "col-12">
                            <div class = "row m-1">
                                <div class = "col-6 text-left">
                                    <span class = "font-weight-bold">รายได้จาก 0900000001</span>
                                </div>
                                <div class = "col-6 ml-auto text-right">
                ...
                <div class = "card-body text-success">
                    <div class = "row align-items-center">
                        <div class = "col-12">
                            <div class = "row m-1">
                                <div class = "col-6 text-left">
                                    <span class = "font-weight-bold">รายได้จาก 0900000002</span>
                                </div>
                                <div class = "col-6 ml-auto text-right">
