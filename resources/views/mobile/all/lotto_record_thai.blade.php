...
<body class="bg-white">
    ...
    <!-- * loader -->
     ...
     <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">โพยหวยไทย</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
                    ...
                    <div class = "row align-items-center">
                        <div class = "col text-left">
                            <h3 class = "text-primary mt-1">
                                งวดที่ 1 วันที่ 1 มกราคม 2564
                            </h3>
                        </div>
                        <div class = "col text-right">
                            <h3 class = "text-danger mt-1">
                                รอการออกผลรางวัล
                            </h3>
                        </div>
                    </div>
                        ...
                        <div class = "col-sm-12 col-md-4 col-lg-4 col-xl-4">
                            <div class = "row m-1">
                                <div class = "col text-center">
                                    <span class = "font-weight-bold">3 ตัวหน้า</span><br>
                                    <span class = "">123</span>
                                </div>
                            </div>
                        </div>
                        <div class = "col-sm-12 col-md-4 col-lg-4 col-xl-4 border-left border-right">
                            <div class = "row m-1">
                                <div class = "col text-center">
                                    <span class = "font-weight-bold">ราคาหวย</span><br>
                                    <span class = "">900 บาท</span>
                                </div>
                            </div>
                        </div>
                        <div class = "col-sm-12 col-md-4 col-lg-4 col-xl-4">
                            <div class = "row m-1">
                                <div class = "col text-center">
                                    <span class = "font-weight-bold">จำนวนเงินรางวัล</span><br>
                                    <span class = "">1,800 บาท</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class = "row align-items-center">
                        <div class = "col text-left">
                            <h4 class = "text-secondary mt-1">
                                วันเวลาที่ซื้อ: งวดที่ 1 วันที่ 1 มกราคม 2564 06:00:00 
                            </h4>
                        </div>
                    </div>
                </div>
                ...
                <div class = "card-body">
                    <div class = "row align-items-center">
                        <div class = "col-sm-12 col-md-4 col-lg-4 col-xl-4">
                            <div class = "row m-1">
                                <div class = "col text-center">
                                    <span class = "font-weight-bold">2 ตัวล่าง</span><br>
                                    <span class = "">98</span>
                                </div>
                            </div>
                        </div>
