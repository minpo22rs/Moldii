        ...
        <div class="login-form mt-1">
            ...
            <div class="section mt-1 mb-5">
                <form action="#">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <input type="text" class="form-control" name = "otp" id="otp" placeholder="เลข OTP" readonly>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                        </div>
                    ...
                    <div class="form-button-group">
                        <button type="button" class="btn btn-primary btn-block btn-lg">ยืนยัน OTP</button>
                    </div>
