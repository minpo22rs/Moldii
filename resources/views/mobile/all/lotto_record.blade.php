...
<body class="bg-white">
    ...
    <!-- * loader -->
     ...
     <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">โพยหวย</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
                    ...
                    <div class = "card-body">
                        <div class = "row align-items-center">
                            <div class = "col-sm-12 col-md-1 col-lg-1 text-center">
                                <div class = "m-1"><img src = "assets/custom_assets/icons/thailand.png" style = "width: 100%;"></div>
                            </div>
                            <div class = "col-sm-12 col-md-11 col-lg-11">
                                <span class = "font-weight-bold">หวยไทย</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class = "section m-1">
                <div class = "card shadow custom_hover">
                    <div class = "card-body">
                        <div class = "row align-items-center">
                            <div class = "col-sm-12 col-md-1 col-lg-1 text-center">
                                <div class = "m-1"> <img class = "rounded-circle"src = "assets/custom_assets/icons/yeekee.jpg" style = "width: 120%;"></ion-icon></div>
                            </div>
                            <div class = "col-sm-12 col-md-11 col-lg-11">
                                <span class = "font-weight-bold">หวยยี่กี</span>
                            </div>
                        </div>
                    </div>
                </div>
