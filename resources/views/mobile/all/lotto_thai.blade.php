                                ...
                                <div class = "col-12 text-center">
                                    <table class="table table-hover align-items-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">1</th>
                                                <td>เลือกเบอร์จากแผง 2 ตัว</td>
                                                <td><input type = "button" class = "btn btn-primary" value = "เลือก"></td>
                                            </tr>

                                            <tr>
                                                <th scope="row">2</th>
                                                <td>พิมพ์เลขด้วยตัวเอง 2 ตัว</td>
                                                <td><input type = "button" class = "btn btn-primary" value = "เลือก"></td>
                                            </tr>

                                            <tr>
                                                <th scope="row">3</th>
                                                <td>เลือกเบอร์จากแผง 3 ตัว</td>
                                                <td><input type = "button" class = "btn btn-primary" value = "เลือก"></td>
                                            </tr>

                                            <tr>
                                                <th scope="row">4</th>
                                                <td>พิมพ์เลขด้วยตัวเอง 3 ตัว</td>
                                                <td><input type = "button" class = "btn btn-primary" value = "เลือก"></td>
                                            </tr>
