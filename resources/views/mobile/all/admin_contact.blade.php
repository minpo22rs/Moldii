...
<body class="bg-white">
    ...
    <!-- * loader -->
     ...
     <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">ติดต่อแอดมิน</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
                    ...
                    <div class = "card-body">
                        <div class = "row align-items-center">
                            <div class = "col-sm-12 col-md-1 col-lg-1 text-center">
                                <div class = "m-1"><img src = "assets/custom_assets/contact_icons/line_logo.png" style = "width: 100%;"></div>
                            </div>
                            <div class = "col-sm-12 col-md-11 col-lg-11">
                                <div class = "row m-1">
                                    <div class = "col text-left"><span class = "font-weight-bold">Line ID:</span></div>
                                </div>
                                <div class = "row m-1">
                                    <div class = "col text-left">my_line_ID</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class = "section m-1">
                <div class = "card shadow">
                    <div class = "card-body">
                        <div class = "row align-items-center">
                            <div class = "col-sm-12 col-md-1 col-lg-1 text-center">
                                <div class = "m-1"><img src = "assets/custom_assets/contact_icons/facebook_logo.png" style = "width: 100%;"></div>
                            </div>
                            <div class = "col-sm-12 col-md-11 col-lg-11">
                                <div class = "row m-1">
                                    <div class = "col text-left"><span class = "font-weight-bold">Facebook:</span></div>
                                </div>
                                <div class = "row m-1">
                                    <div class = "col text-left">url_facebook</div>
                                </div>
                            </div>
                        </div>
                    </div>
